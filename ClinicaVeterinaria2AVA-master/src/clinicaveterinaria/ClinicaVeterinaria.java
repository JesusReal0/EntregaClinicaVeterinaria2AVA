...
public class ClinicaVeterinaria {
    ...
    public static void main(String[] args) throws IOException {
        ...
        do {
        	muestraMenu();
            final String EXCEPCIONENTERO = "Has causado una excepci�n porque no has entrado un n�mero entero, gracias";
			try {
			...
			switch (numero) {
				...
				altaMascota(teclado, listaMascotas, clientes, EXCEPCIONENTERO, nomCliente);
                    break;
	...
	private static void altaMascota(BufferedReader teclado, ArrayList<Mascota> listaMascotas,
			ArrayList<Persona> clientes, final String EXCEPCIONENTERO, String nomCliente) throws IOException {
